...
class Hostel_Management:
    def __init__(self, root):
        ...
        label = Label(self.root, text="Hostel Management System", bg="black", fg="gold", font=("Time New Romen", 30, "bold"))
        label.pack(fill=X)

        frame2 = Frame(self.root, width=250, height=650, bg="#2F4F4F")
        frame2.place(x=0, y=52)

        label2 = Label(frame2, text="Menu", font=("Time New Romen", 16, "bold"), bg="#2F4F4F", fg="white")
        ...
        b5 = Button(frame2, text="Manage Report", command=self.report_win, bg="black", fg="gold", bd=0, width=20, font=("Time New Romen", 14, "bold"))
        b5.place(x=2, y=320)

        b6 = Button(frame2, text="Logout", command=self.exit_window, bg="black", fg="gold", bd=0, width=20, font=("Time New Romen", 14, "bold"))
        b6.place(x=2, y=370)
